...
export const getAllBorrowBooks = async (req: Request, res: Response) => {
  try {
    const BorrowBooks = await prisma.borrowRecord.findMany();
...
export const getOverdueBorrowList = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
